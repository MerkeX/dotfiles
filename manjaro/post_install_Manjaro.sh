...
lib32-mesa-demos lib32-mesa-vdpau lib32-opencl-mesa lib32-vulkan-intel lib32-vulkan-radeon libdvdcss libgsf libopenraw libreoffice-fresh\
libva-intel-driver libva-mesa-driver libva-vdpau-driver libzip licenses light-locker lightdm lightdm-gtk-greeter\
lightdm-gtk-greeter-settings lightdm-webkit-theme-litarvan lightdm-webkit2-greeter lightdm-webkit2-theme-obsidian lightdm-webkit2-theme-sapphire links linux-firmware linux-latest linux-lts\
linux-lts-headers logrotate lsb-release lvm2 lxappearance tint2 obconf obmenu3 m4 make man-db man-pages manjaro-alsa manjaro-application-utility\
arc-gtk-theme arc-dark-xfce4-terminal arc-maia-icon-theme arc-solid-gtk-theme arc-themes-breath arc-themes-maia arc-themes-solid-breath arc-themes-solid-maia \
manjaro-browser-settings manjaro-documentation-en manjaro-firmware manjaro-hello manjaro-hotfixes manjaro-printer manjaro-pulse\
manjaro-release manjaro-settings-manager manjaro-settings-manager-notifier manjaro-system manjaro-wallpapers-18.0\
manjaro-xfce-settings matcha-gtk-theme mdadm memtest86+ menulibre mesa-demos mesa-vdpau mhwd mhwd-db mixxx mkinitcpio-openswap\
mlocate mobile-broadband-provider-info modemmanager mousepad mpc mpd mtpfs mugshot nano neofetch network-manager-applet\
networkmanager networkmanager-openconnect networkmanager-openvpn networkmanager-pptp networkmanager-vpnc nfs-utils nikto nmap\
noto-fonts noto-fonts-cjk nss-mdns ntfs-3g ntp numlockx open-vm-tools openbox opencl-mesa openresolv openssh orage os-prober\
p7zip pacman pamac-flatpak-plugin pamac-gtk pamac-snap-plugin patch pavucontrol pciutils perl perl-file-mimeinfo picom pkgconf\
playerctl playonlinux polybar poppler-data poppler-glib powerline powertop procps-ng psmisc pulseaudio-bluetooth pulseaudio-ctl\
pulseaudio-zeroconf python-pycurl python2-requests qbittorrent qt4 radeontool rclone reiserfsprogs rhythmbox ristretto rofi rsync\
s-nail samba screenfetch sed shadow snapd snapd-glib spectre-meltdown-checker speedtest-cli steam-manjaro sudo sysfsutils\
