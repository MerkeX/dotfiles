...
sudo git clone --depth 1 git://github.com/void-linux/void-packages.git /opt/void-packages
...
# Mojave dark
cd ~/temp
git clone --depth 1 https://github.com/MerkeX/Mojave-kvantum.git /usr/share/themes/Mojave-kvantum
...
# Kripton theme
cd ~/temp
git clone --depth 1 https://github.com/MerkeX/Kripton.git /usr/share/themes/Kripton
...
git clone --depth 1 https://github.com/addy-dclxvi/openbox-theme-collections /usr/share/themes
...
# Numix icon theme
cd ~/temp
git clone --depth 1 https://github.com/MerkeX/numix-icon-theme.git
cd numix-icon-theme/
rm license readme.md && sudo cp -r * Numix Numix-Light /usr/share/icons
cd .. && rm -rf numix-icon-theme/

# Numix circle theme
git clone --depth 1 https://github.com/MerkeX/numix-icon-theme-circle.git
...
# Mojave-CT icon
git clone --depth 1 https://github.com/MerkeX/Mojave-CT.git /usr/share/icons/Mojave-CT
...
# OS Catalina icons
git clone --depth 1 https://github.com/MerkeX/Os-Catalina-icons.git /usr/share/icons/OS-Catalina
